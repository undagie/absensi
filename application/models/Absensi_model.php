...
class Absensi_model extends CI_Model
{
    ...
    {
        $this->db->select("DATE_FORMAT(a.tgl, '%d-%m-%Y') AS tgl, a.waktu AS jam_masuk, (SELECT waktu FROM absensi al WHERE al.tgl = a.tgl AND al.keterangan != a.keterangan) AS jam_pulang");
